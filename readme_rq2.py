...
def generate_rq_table(rq_number, output_dir="tables"):
    ...
    markdown = [
        f"<table><thead><tr><td colspan='{len(table_headers)}'><b>RESULTS FOR RQ{rq_number}: What is the adoption of archival infrastructures cross the disciplines?</b></td></tr></thead>",
        "<tbody>",
