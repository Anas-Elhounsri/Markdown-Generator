...
def generate_rq_table(rq_number, output_dir="tables"):
    ...
    table_headers = ["Metadata", "ESCAPE", "PANOSC", "ENVRI", "RSD"]
    row_mapping = {
        "cff": "CFF file",
        "readme": "README",
    ...
    markdown = [
        f"<table><thead><tr><td colspan='{len(table_headers)}'><b>RESULTS FOR RQ{rq_number}: HOW DO COMMUNITIES DESCRIBE RS METADATA</b></td></tr></thead>",
        "<tbody>",
